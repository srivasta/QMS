...
#ifndef	REMOS_FLOW_PROBE_H
#define REMOS_FLOW_PROBE_H
...
/** @defgroup RemosProbes Remos Probes - probes for network QoS metrics 
 * @ingroup Continuous
 * These probes deliver QoS metrics from the Remos software in the form
 * of available network bandwidth in a network as well as the logical network
 * topology.
 *
 */
