...
#ifndef	LINUX_PERF_MON_PROBE_H
#define LINUX_PERF_MON_PROBE_H


/** @file Linux_Perf_Mon_Probe.h
 *  @ingroup Continuous
...
int repeat_count = 1;
struct timespec repeat_interval;
