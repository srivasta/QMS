...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:probe="http://www.stdc.com/2001/QMS/Probes/Continuous/GenericProbe"
  version="$Id: genericCProbe.xsl,v 1.2 2001/12/01 19:13:02 nath Exp $">
  ...
  <xsl:variable
    name="payloadElement"
    select="/qms:QMSMessage/qms:payload/probe:genericCProbe"/>
  <xsl:variable
    name="action"
