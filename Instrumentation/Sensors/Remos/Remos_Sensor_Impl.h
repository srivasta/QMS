...
// Last Modified On : Tue Oct 30 13:29:26 2001
...
/** @file Remos_Sensor_Impl.h
 *  @ingroup RemosSensor 
 *  @brief  A Generic Sensor Implementation
 *
 *
 ...
 *
 * $Id: Remos_Sensor_Impl.h,v 1.23 2002/02/15 19:01:00 nath Exp $
 */

#ifndef _REMOS_SENSOR_IMPL_H_
#define _REMOS_SENSOR_IMPL_H_
...
#include "Message_Format_Remos.h"
...
namespace STDC
{
  namespace QMS
  {
    namespace Citizen
    {
       ...
       */
      class Remos_Sensor_Impl : public POA_STDC::QMS::Citizen::Remos_Sensor
      {
      public:
	/// The default constructor for the class Remos_Sensor_Impl
	Remos_Sensor_Impl();
	///the copy constructor
	Remos_Sensor_Impl(const Remos_Sensor_Impl& rhs);
	/// the assignment operator
	Remos_Sensor_Impl& operator=(const Remos_Sensor_Impl& rhs);
	
	/// the default address-of operators
	// Remos_Sensor_Impl* operator&()             { return this; };
	// const Remos_Sensor_Impl* operator&() const { return this; };
	
	/// the destructor
	~Remos_Sensor_Impl(){ this->cleanup(); };
	...
	/// Read the capability file and create the meta data objects
	bool parse_capability(void);
	...
	/// Handle the external probes
	void external_probes(void);
	...
	CORBA::Long _supplier_id;
        ...
        std::map<std::string, STDC::QMS::Citizen::Meta_Data_Remos *> probes_;
	...
	/// The location of the capability file
	string _capability_file;
	STDC::QMS::sensorCapability capability;
	...
	bool _registered;
      };	// end of class Remos_Sensor_Impl
    };
  }
};

#endif /* _REMOS_SENSOR_IMPL_H_ */
