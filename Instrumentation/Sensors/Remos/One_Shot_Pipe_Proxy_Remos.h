 ...
 * HISTORY          : 
 * Description      : 
 * $Id: One_Shot_Pipe_Proxy_Remos.h,v 1.9 2001/12/09 02:14:18 nath Exp $
 */
...
#ifndef _ONE_SHOT_PIPE_PROXY_REMOS_H_
#define _ONE_SHOT_PIPE_PROXY_REMOS_H_
...
#define DEFAULT_SLEEP 2
       ...
       * loop. 
       */
      class One_Shot_Pipe_Proxy_Remos: public virtual STDC::QMS::Citizen::Pipe_Proxy_Remos
      {
      public:
	/// The default constructor for the class One_Shot_Pipe_Proxy_Remos
	One_Shot_Pipe_Proxy_Remos(const char *file_name_p, char *const argv[], 
	...
	/// the destructor
	Dllexport virtual ~One_Shot_Pipe_Proxy_Remos(){};
	...
	int iterations_;
      };	// end of class One_Shot_Pipe_Proxy_Remos
    };
  };
};
...
#endif /* _ONE_SHOT_PIPE_PROXY_REMOS_H_ */
