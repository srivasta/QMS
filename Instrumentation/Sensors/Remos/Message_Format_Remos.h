...
/** @file Message_Format_Remos.h
 *  @ingroup RemosSensor
 *  @brief C++ representation of the payload data for the hello world probe
 *
 * $Id: Message_Format_Remos.h,v 1.13 2001/12/09 02:14:17 nath Exp $
 */

#ifndef _MESSAGE_FORMAT_REMOS_H_
#define _MESSAGE_FORMAT_REMOS_H_
...
struct probe_info
{
  ...
  STDC::QMS::Citizen::Probe_Proxy_Remos * probe_p; /// associated probe
};
...
#endif /* _MESSAGE_FORMAT_REMOS_H_ */
