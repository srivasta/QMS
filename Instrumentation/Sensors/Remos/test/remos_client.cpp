...
// Last Modified On : Sat Dec  1 03:25:36 2001
 ...
 *
 * $Id: remos_client.cpp,v 1.10 2001/12/09 02:14:18 nath Exp $
 */
  ...
  for (int i = 0; i < argc; i++)
   {
	...
	exit (0);
     ...
     if (strchr((argv[i] + j), 'f'))
      {
          hostfile = (char *) malloc (strlen(argv[i + 1]) + 1);
