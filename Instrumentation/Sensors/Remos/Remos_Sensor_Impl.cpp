//                              -*- Mode: C++ -*- 
// Remos_Sensor_Impl.cpp --- 
// Author           : Manoj Srivastava ( srivasta@glaurung.stdc.com ) 
// Created On       : Mon Sep  3 15:21:17 2001
// Created On Node  : glaurung.stdc.com
// Last Modified By : Manoj Srivastava
// Last Modified On : Thu Dec  6 16:48:56 2001
...
/** @file Remos_Sensor_Impl.cpp
 *  @ingroup RemosSensor 
 *  @brief The implementation of the servant
 *
 *  $Id: Remos_Sensor_Impl.cpp,v 1.81 2002/02/15 18:50:57 nath Exp $
 */
 ...
 *
 */
STDC::QMS::Citizen::Remos_Sensor_Impl::Remos_Sensor_Impl() :
  _parser_initialized(false), _activated(false), _offer_created(false)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::Remos_Sensor_Impl", 
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::Remos_Sensor_Impl\n");
}
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::init(STDC::QMS::CORBA_Handles *handles_p,
					   string credentials, 
					   char *config_file_p,
					   CORBA::Environment &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::init", __LINE__, __FILE__);
  DEBUG0(2, "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::init\n");
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::cleanup(void)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::cleanup", __LINE__,
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::cleanup");
  DEBUG0(4, "withdrawing offers");
  this->withdraw_offer();

  DEBUG0(4, "Cleaning up probes");
  std::map<std::string, STDC::QMS::Citizen::Meta_Data_Remos *>::iterator pos;
...
/**
 * @brief Create Meta_Data_Remos objects for all probes defined in the capability file
 *
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::external_probes(void)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::external_probes", __LINE__,
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::external_probes");
  ...
  for(iter = this->capability.begin(); iter != this->capability.end(); iter++)
   {
     ...
     STDC::QMS::Citizen::Meta_Data_Remos *probe_p = 
       new STDC::QMS::Citizen::Meta_Data_Remos();
     assert(probe_p);
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::builtin_probes(void)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::builtin_probes", __LINE__,
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::builtin_probes");
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::add_handle(STDC::QMS::CORBA_Handles
						 *handles_p)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::add_handle", __LINE__,
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::add_handle");
  if(!handles_p)
   {
...
STDC::QMS::Citizen::Remos_Sensor_Impl::get_handle(void)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::get_handle", __LINE__, 
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::get_handle");
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::activate(CORBA::Environment &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::activate", __LINE__,
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::activate");
  if(this->_activated)
   {
     return;
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::deactivate(CORBA::Environment 
						 &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::deactivate", __LINE__, 
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::deactivate");
  if(! this->_activated)
   {
     return;
   } /* end of if(! this->_activated) */
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::get_security_policy(string credentials, 
						 string &policy)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::get_security_policy",
	    __LINE__, __FILE__);
  DEBUG0(2,
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::get_security_policy\n");
  DEBUG1(2, "DEBUG: Credentials %s\n", credentials.c_str());
  if(!credentials.empty())
   {
     std::cout << "init: credentials" << credentials.c_str() << std::endl;
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::set_security_policy(string policy, 
						 string credentials)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::set_security_policy",
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::set_security_policy\n");
  DEBUG1(2, "DEBUG: Credentials %s\n", credentials.c_str());
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::get_attributes(string credentials, 
						     string &attributes)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::get_attributes",
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::get_attributes\n");
  DEBUG1(2,
	 "DEBUG: Credentials %s\n", credentials.c_str());
  if(!credentials.empty())
   {
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::set_attributes(string attributes,
					    string credentials)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::set_attributes", 
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::set_attributes\n");
  DEBUG1(2, "DEBUG: Credentials %s\n", credentials.c_str());
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::reload_configuration(string reason, 
						  string credentials)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::reload_configuration",
	    __LINE__, __FILE__);
  DEBUG0(2,
	"DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::reload_configuration\n");
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::start(string credentials)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::start", __LINE__, __FILE__);
  DEBUG0(2, "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::start\n");
  DEBUG1(2, "DEBUG: Credentials %s\n", credentials.c_str());
  if(!credentials.empty())
   {
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::pause(const char * reason, 
				   const char * credentials, 
				   CORBA::Short_out ack)
  ACE_THROW_SPEC ((STDC::QMS::QMS_Error, CORBA::SystemException))

{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::pause", __LINE__, __FILE__);
  DEBUG0(2, "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::pause\n");
  DEBUG2(2, "DEBUG: Credentials %s; reason: %s\n",
	 credentials, reason );
  ACE_TRY
    {
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::resume(const char * reason, 
				    const char * credentials, 
				    CORBA::Short_out ack)
  ACE_THROW_SPEC ((STDC::QMS::QMS_Error, CORBA::SystemException))
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::resume", __LINE__, 
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::resume\n");
  DEBUG2(2, "DEBUG: Credentials %s; reason: %s\n",
	 credentials, reason );
  ACE_TRY
    {
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::stop(const char *reason, 
				  const char *credentials, 
				  CORBA::Short_out ack)
  ACE_THROW_SPEC ((STDC::QMS::QMS_Error, CORBA::SystemException))
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::stop", __LINE__, __FILE__);
  DEBUG0(2, "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::stop\n");
  DEBUG2(2, "DEBUG: Credentials %s; reason: %s\n",
	 credentials, reason );
  ACE_TRY
    {
 ...
 */
void 
STDC::QMS::Citizen::Remos_Sensor_Impl::connect_EC (string credentials)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::connect_EC", __LINE__,
	    __FILE__);
  DEBUG0(2,
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::connect_EC\n");
  DEBUG1(2, 
	 "DEBUG: Credentials %s\n", credentials.c_str() );
  if(!credentials.empty())
   {
 ...
 */
void 
STDC::QMS::Citizen::Remos_Sensor_Impl::probe_offers (string credentials)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::probe_offers", __LINE__,
	    __FILE__);
  DEBUG0(2,
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::probe_offers\n");
  DEBUG1(2, 
	 "DEBUG: Credentials %s\n", credentials.c_str() );
  if(!credentials.empty())
   {
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::disconnect_EC (const char * reason, 
			       const char * credentials)
  ACE_THROW_SPEC ((STDC::QMS::Citizen::QMS_Citizen_Error, 
                   CORBA::SystemException))
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::disconnect_EC", __LINE__,
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::disconnect_EC\n");
  DEBUG2(2, "DEBUG: Credentials %s; reason: %s\n",
	 credentials, reason );
  ACE_TRY
    {
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::reconnect_EC (const char * reason, 
			      const char * EC_Name,
			      const char * credentials)
  ACE_THROW_SPEC ((STDC::QMS::Citizen::QMS_Citizen_Error, 
                   CORBA::SystemException))
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::reconnect_EC", __LINE__,
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::reconnect_EC\n");
  DEBUG2(2, "DEBUG: Credentials %s; reason: %s\n",
	 credentials, reason );
  ACE_TRY
    {
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::show_operating_level (CORBA::Short_out 
							    level)
  ACE_THROW_SPEC ((CORBA::SystemException))
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::show_operating_level",
	    __LINE__, __FILE__);
  DEBUG0(2,
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::show_operating_level\n");
  level = this->level_;
}
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::set_operating_level (CORBA::Short level,
				     const char * credentials)
  ACE_THROW_SPEC ((STDC::QMS::Citizen::QMS_Citizen_Error,
                   CORBA::SystemException))
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::set_operating_level",
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::set_operating_level\n");
  DEBUG1(2, "DEBUG: Credentials %s\n", credentials);
  ACE_TRY
    {
      if(credentials)
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::stats (const char * credentials,
					     CORBA::String_out stats)
  ACE_THROW_SPEC ((CORBA::SystemException))
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::stats", __LINE__, __FILE__);
  DEBUG0(2, "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::stats\n");
  DEBUG1(2, "DEBUG: Credentials %s\n", credentials);
  if(credentials)
   {
     std::cout << "reload_configuration: credentials" << credentials 
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::ping (CORBA::Short_out ack)
  ACE_THROW_SPEC ((STDC::QMS::Citizen::QMS_Citizen_Error,
                   CORBA::SystemException))
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::ping", __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::ping\n");
  ack = 1;
}
 ...
 * @param ACE_TRY_ENV CORBA env for propogating exceptions
 *
 * We register this sensor under /stdc/QMS/Instrumentation/Sensor/Remos_Sensor
 * This routine handles cases where parts of the path may already be
 * already bound.
 */
void 
STDC::QMS::Citizen::Remos_Sensor_Impl::register_with_naming(CORBA::Environment
							    &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::register_with_naming", 
	    __LINE__, __FILE__);
  DEBUG0(2,
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::register_with_naming");
  if(this->_registered)
   {
     return;
  ...
  ACE_TRY
    {
      name.length (5);
      name[4].id = CORBA::string_dup ("Remos");
      sensor_context_p = init_context_p->bind_new_context (name);
    }
  ACE_CATCH (CosNaming::NamingContext::AlreadyBound, ex)
    {
      ACE_PRINT_EXCEPTION (ex, "Remos:NS context already bound :(ignored)");
      ACE_TRY_ENV.clear();
    }
  ACE_CATCHANY
    {
...
// Not yet implemented
void 
STDC::QMS::Citizen::Remos_Sensor_Impl::unregister_with_naming(CORBA::Environment &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::unregister_with_naming",
	    __LINE__,__FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::unregister_with_naming");
  if(!this->handles_p_)
   {
     throw STDC::QMS::QMS_Error();
   } /* end of if(!this->handles_p_) */
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::update_registration(string reason,
							  string credentials)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::update_registration", 
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::update_registration\n");
  DEBUG2(2, "DEBUG: Credentials %s; reason: %s\n",
	 credentials.c_str(), reason.c_str() );
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::withdraw_offer(CORBA::Environment 
						     &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::withdraw_offer", __LINE__, 
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::withdraw_offer\n");
...
void
STDC::QMS::Citizen::Remos_Sensor_Impl::make_offer(CORBA::Environment 
						 &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::make_offer", __LINE__, 
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::make_offer\n");
  ACE_TRY
    {
      CosTrading::Lookup_var lookup_var =
	this->handles_p_->get_lookup_handle(ACE_TRY_ENV);
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::yp_offer(CORBA::Environment &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::yp_offer", __LINE__,
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::yp_offer\n");
  bool retry = true;
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::get_ec_registry(CORBA::Environment 
						      &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::get_ec_registry", 
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::get_ec_registry\n");
  if(!CORBA::is_nil(this->_ec_registry.in()))
   {
     return;
   } /* end of if(!CORBA::is_nil(this->_ec_registry)) */
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::get_supplier_id(CORBA::Environment 
						      &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::get_supplier_id", 
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG: STDC::QMS::Citizen::Remos_Sensor_Impl::get_supplier_id\n");
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::get_ECInfo(CORBA::Environment 
						 &ACE_TRY_ENV)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::get_ECInfo", __LINE__,
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:  STDC::QMS::Citizen::Remos_Sensor_Impl::get_ECInfo\n");
  ACE_TRY
    {
     if(CORBA::is_nil(this->_ec_registry.in()))
       {
 ...
 */
void
STDC::QMS::Citizen::Remos_Sensor_Impl::init_parser()
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::init_parser",__LINE__, 
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::init_parser");
 ...
 */
void 
STDC::QMS::Citizen::Remos_Sensor_Impl::parser_cleanup(void)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::parser_cleanup",__LINE__, 
	    __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::parser_cleanup\n");
 ...
 */
bool 
STDC::QMS::Citizen::Remos_Sensor_Impl::parse_capability(void)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::parse_capability",
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::parse_capability");
 ...
 */
bool 
STDC::QMS::Citizen::Remos_Sensor_Impl::parse_config(char * file_name_p)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::parse_config",
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::parse_config");
  if(file_name_p)
   {
     STDC::QMS::Parse_XML *parser_p = new STDC::QMS::Parse_XML();
...
void
STDC::QMS::Citizen::Remos_Sensor_Impl::handle_query(const string &query)
{
  QMS_Trace("STDC::QMS::Citizen::Remos_Sensor_Impl::handle_query", 
	    __LINE__, __FILE__);
  DEBUG0(2, 
	 "DEBUG:STDC::QMS::Citizen::Remos_Sensor_Impl::handle_query");
...
template class map<std::string, STDC::QMS::Citizen::Meta_Data_Remos *>;
template class map<std::string, query_info *>;

#  if defined(__GNUC_MINOR__) && __GNUC_MINOR__ > 92
template class _Rb_tree<string, pair<string const, STDC::QMS::Citizen::Meta_Data_Remos *>, _Select1st<pair<string const, STDC::QMS::Citizen::Meta_Data_Remos *> >, less<string >, allocator<STDC::QMS::Citizen::Meta_Data_Remos *> >;
...
#  else
template class rb_tree<string, pair<string const, STDC::QMS::Citizen::Meta_Data_Remos *>, select1st<pair<string const, STDC::QMS::Citizen::Meta_Data_Remos *> >, less<string>, __default_alloc_template<true, 0> >;
...
#pragma instantiate class map<std::string, STDC::QMS::Citizen::Meta_Data_Remos *>
#pragma instantiate class _Rb_tree<string, pair<string const, STDC::QMS::Citizen::Meta_Data_Remos *>, _Select1st<pair<string const, STDC::QMS::Citizen::Meta_Data_Remos *> >, less<string >, allocator<STDC::QMS::Citizen::Meta_Data_Remos *> >
