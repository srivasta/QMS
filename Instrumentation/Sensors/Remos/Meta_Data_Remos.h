 ...
 *
 * $Id: Meta_Data_Remos.h,v 1.27 2001/12/09 02:14:18 nath Exp $
 */


#ifndef _META_DATA_REMOS_H_
#define _META_DATA_REMOS_H_
...
namespace STDC
{
  namespace QMS
  {
	...
	{ 
      ...
      // forward definition
      class Probe_Proxy_Remos;
      class Meta_Data_Remos;
      ...
      {
      public:
	/// The default constructor for the classMeta_Data_Remos
	Meta_Data_Remos();
	///the copy constructor
	Meta_Data_Remos(Meta_Data_Remos& rhs);
	/// the assignment operator
	const Meta_Data_Remos operator=(Meta_Data_Remos& copy);
	...
	// Meta_Data_Remos* operator&()             { return this; };
	// const Meta_Data_Remos* operator&() const { return this; };

	/// the destructor
	~Meta_Data_Remos(){ this->cleanup(); };
	...
	void add_announce_info(STDC::QMS::Citizen::Sensor_Data_Element_Remos* param);
	/// Add information about an request channel
	void add_request_info(STDC::QMS::Citizen::Sensor_Data_Element_Remos * param);
	/// Add information about an data channel
	void add_data_info(STDC::QMS::Citizen::Sensor_Data_Element_Remos    * param);
	...
	vector<STDC::QMS::Citizen::Sensor_Data_Element_Remos *> announce_list_info_;
	/// EC information about request channels
	vector<STDC::QMS::Citizen::Sensor_Data_Element_Remos *> request_list_info_;
	/// EC information about data channels
	vector<STDC::QMS::Citizen::Sensor_Data_Element_Remos *> data_list_info_;
	...
	/// generated messages
	string _QMS_Schema;
      };	// end of class Meta_Data_Remos
    };
  };
};


#endif /* _META_DATA_REMOS_H_ */
