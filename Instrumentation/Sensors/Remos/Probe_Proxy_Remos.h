 ...
 * HISTORY          : 
 * Description      : 
 * $Id: Probe_Proxy_Remos.h,v 1.11 2001/12/09 02:14:18 nath Exp $
 */
 ...
 *
 */
#ifndef _PROBE_PROXY_REMOS_H_
#define _PROBE_PROXY_REMOS_H_
...
namespace STDC
{
  namespace QMS
  {
    namespace Citizen
    {
      ...
      {
      public:
	/// The default constructor for the class Probe_Proxy_Remos
	Probe_Proxy_Remos(Meta_Data_Remos& parent, string &key):
	...
	/// the destructor
	virtual ~Probe_Proxy_Remos()
	{
	  QMS_Trace("STDC::QMS::Citizen::Probe_Proxy_Remos::~Probe_Proxy_Remos",__LINE__,
		    __FILE__);
	  DEBUG0 (4, "DEBUG: STDC::QMS::Citizen::~Probe_Proxy_Remos");
	  this->_key.erase(); 
	  DEBUG0 (4, "DEBUG: ~Probe_Proxy_Remos -- done");
	};
	...
	Meta_Data_Remos & _metadata;
	/// The unique key that identifies a request to the sensor
	string _key;

      private:
	
      };	// end of class Probe_Proxy_Remos    
    };
  };
};
  

#endif /* _PROBE_PROXY_REMOS_H_ */
