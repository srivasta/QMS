...
// HISTORY          : 
// Description      : 
// $Id: One_Shot_Pipe_Proxy_Remos.cpp,v 1.10 2001/12/09 02:14:18 nath Exp $
// 
...
#include "Debug.h"
#include "One_Shot_Pipe_Proxy_Remos.h"
 ...
 *
 * We initialize the parent Pipe_Proxy_Remos class object, as well as the
 * internal variables refresh_rate_ and iterations_
 */
STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::One_Shot_Pipe_Proxy_Remos
...
{
  QMS_Trace("STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::One_Shot_Pipe_Proxy_Remos", 
	    __LINE__, __FILE__);
  DEBUG0 (2,
	 "DEBUG:STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::One_Shot_Pipe_Proxy_Remos");
  // do nothing
}
 ...
 */
int 
STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::send_command(const string command)
{
  QMS_Trace("STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::send_command", __LINE__,
	    __FILE__);
  DEBUG0 (2,
	  "DEBUG:STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::send_command");
 ...
 */
int 
STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::start(void)
{
  QMS_Trace("STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::start", __LINE__,
            __FILE__);
  DEBUG0 (2,
          "DEBUG:STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::start");
  {
 ...
 */
int
STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::pause(void)
{
  QMS_Trace("STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::pause", __LINE__,
	    __FILE__);
  DEBUG0 (2, 
	  "DEBUG:STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::pause");
 ...
 */
int 
STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::resume(void)
{
  QMS_Trace("STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::resume", __LINE__, 
	    __FILE__);
  DEBUG0 (2,
	  "DEBUG:STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::resume");
  {
    ACE_Read_Guard<ACE_RW_Thread_Mutex> guard(this->lock_);
    if(this->Am_I_Active)
     {
 ...
 */
int
STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::kill(void)
{
  QMS_Trace("STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::kill", __LINE__,
	    __FILE__);
  DEBUG0 (2, 
	  "DEBUG:STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::kill");
  ACE_Write_Guard<ACE_RW_Thread_Mutex> guard(this->lock_);
  this->status_ = KILLED;
  return 0;
}
 ...
 */
void
STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::destroy(void)
{
  QMS_Trace("STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::destroy", __LINE__,
	    __FILE__);
  DEBUG0 (2, 
	  "DEBUG:STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::destroy");

  this->~One_Shot_Pipe_Proxy_Remos();
}
 ...
 */
int 
STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::deploy(void)
{
  QMS_Trace("STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::deploy", __LINE__, 
	    __FILE__); 
  DEBUG0 (2,
	  "DEBUG:STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::deploy");
  ...
  for(int i =0; i < this->iterations_; i++)
   {
	...
	DEBUG0 (4, 
		"DEBUG:STDC::QMS::Citizen::One_Shot_Pipe_Proxy_Remos::deploy exec");
