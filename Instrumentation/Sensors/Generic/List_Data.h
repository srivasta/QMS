 ...
 * 
 * $Id: List_Data.h,v 1.10 2001/12/09 02:11:58 nath Exp $
 */
...
namespace STDC
{
  namespace QMS
  {
    namespace Citizen
    {
       ...
       */
      class Sensor_Data_Element
      {
      public:
	/**
	 * @brief  The default constructor for the class Sensor_Data_Element 
	 * @param name The associated name of this element
	 * @param value The associated numerical value
	 */
	Sensor_Data_Element (string name = "", int value = 0) :
	  _name(name), _valInt(value),_valString("")
	{
	  QMS_Trace ("Sensor_Data_Element", __LINE__, __FILE__);
	};
	 ...
	 */
	Sensor_Data_Element(string name, string value) :
	...
	Sensor_Data_Element(const Sensor_Data_Element& rhs) :
	...
	Sensor_Data_Element& 
	operator=(const Sensor_Data_Element& rhs)
	{
	  QMS_Trace ("Sensor_Data_Element::operator=", __LINE__, __FILE__);
	  if(&rhs != this)
	   {
	...
	// Sensor_Data_Element* operator&()             { return this; };
	// const Sensor_Data_Element* operator&() const { return this; };
	/**
	...
	ACE_Thread_Mutex asset_guard;
      };	// end of class Sensor_Data_Element
    };
  };
};
