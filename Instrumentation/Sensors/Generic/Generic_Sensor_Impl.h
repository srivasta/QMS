//                              -*- Mode: C++ -*- 
// Generic_Sensor_Impl.h --- 
// Author           : Manoj Srivastava ( srivasta@glaurung.stdc.com ) 
// Created On       : Mon Sep  3 14:02:55 2001
// Created On Node  : glaurung.stdc.com
// Last Modified By : Manoj Srivastava
// Last Modified On : Fri Feb 15 10:58:22 2002
 ...
 *
 * $Id: Generic_Sensor_Impl.h,v 1.22 2002/02/15 17:19:25 srivasta Exp $
 */

#ifndef _GENERIC_SENSOR_IMPL_H_
#define _GENERIC_SENSOR_IMPL_H_
...
namespace STDC
{
  namespace QMS
  {
    namespace Citizen
    {
       ...
       */
      class Generic_Sensor_Impl : public POA_STDC::QMS::Citizen::Generic_Sensor
      {
      public:
	/// The default constructor for the class Generic_Sensor_Impl
	Generic_Sensor_Impl();
	///the copy constructor
	Generic_Sensor_Impl(const Generic_Sensor_Impl& rhs);
	/// the assignment operator
	Generic_Sensor_Impl& operator=(const Generic_Sensor_Impl& rhs);
	
	/// the default address-of operators
	// Generic_Sensor_Impl* operator&()             { return this; };
	// const Generic_Sensor_Impl* operator&() const { return this; };
	
	/// the destructor
	~Generic_Sensor_Impl(){ this->cleanup(); };
	...
	CORBA::Long _supplier_id;
        ...
        std::map<std::string, STDC::QMS::Citizen::Meta_Data *> probes_;
	...
	bool _registered;
      };	// end of class Generic_Sensor_Impl
    };
  }
};

#endif /* _GENERIC_SENSOR_IMPL_H_ */
