...
// Last Modified On : Wed Jan  9 15:12:34 2002
...
"$Id: CallBack.cpp,v 1.22 2002/01/09 21:23:37 srivasta Exp $";
...
#ifndef SILENT_MODE  
  std::cerr << "\tFinished Handling Request\n";  
#endif
}
...
CallBack (const string &query, void *arg_p)
{
  ...
  packed_p->sensor_p = (STDC::QMS::Citizen::Generic_Sensor_Impl *) arg_p;
