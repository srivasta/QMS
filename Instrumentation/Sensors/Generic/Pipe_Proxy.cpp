...
// Last Modified On : Thu Dec  6 12:35:57 2001
// Last Machine Used: glaurung.green-gryphon.com
// Update Count     : 12
// Status           : Unknown, Use with caution!
// HISTORY          : 
// Description      : 
// $Id: Pipe_Proxy.cpp,v 1.8 2001/12/09 02:11:58 nath Exp $
// 
 ...
 */
int
STDC::QMS::Citizen::Pipe_Proxy::init(const char *file_name_p,
				     char *const argv[])
{
  QMS_Trace("STDC::QMS::Citizen::Pipe_Proxy::init", __LINE__, __FILE__);
  DEBUG0 (2, "DEBUG:STDC::QMS::Citizen::Pipe_Proxy::init"); 
 ...
 *
 */
STDC::QMS::Citizen::Pipe_Proxy::~Pipe_Proxy()
{
  QMS_Trace("STDC::QMS::Citizen::Pipe_Proxy::~Pipe_Proxy", __LINE__,
	    __FILE__);
  DEBUG0 (2, "DEBUG:STDC::QMS::Citizen::Pipe_Proxy::~Pipe_Proxy"); 
  ...
  DEBUG0 (4, "DEBUG: Done with ~Pipe_Proxy");
}
