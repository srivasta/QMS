 ...
 * Last Modified On : Sat Oct 20 03:42:02 2001
 ...
 * 
 * $Id: List_Data_HW.h,v 1.1 2001/11/28 19:24:43 srivasta Exp $
 */


#ifndef _LIST_DATA_HW_H_
#define _LIST_DATA_HW_H_
...
namespace STDC
{
  namespace QMS
  {
    namespace Citizen
    {
       ...
       */
      class Sensor_Data_Element_HW
      {
      public:
	/**
	 * @brief  The default constructor for the class Sensor_Data_Element_HW 
	 * @param name The associated name of this element
	 * @param value The associated numerical value
	 */
	Sensor_Data_Element_HW (string name = "", int value = 0) :
	  _name(name), _valInt(value),_valString("")
	{
	  QMS_Trace ("Sensor_Data_Element_HW", __LINE__, __FILE__);
	};
	 ...
	 */
	Sensor_Data_Element_HW(string name, string value) :
	...
	Sensor_Data_Element_HW(const Sensor_Data_Element_HW& rhs) :
	...
	Sensor_Data_Element_HW& 
	operator=(const Sensor_Data_Element_HW& rhs)
	{
	  QMS_Trace ("Sensor_Data_Element_HW::operator=", __LINE__, __FILE__);
	  if(&rhs != this)
	   {
	...
	// Sensor_Data_Element_HW* operator&()             { return this; };
	// const Sensor_Data_Element_HW* operator&() const { return this; };
	/**
	...
	ACE_Thread_Mutex asset_guard;
      };	// end of class Sensor_Data_Element_HW
    };
  };
};


#endif /* _LIST_DATA_HW_H_ */
